...
<h1 align="center">mtr cityrail france launcher</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `MTR-CityRail-France-Launcher-win-x64.exe ` |
| macOS | `MTR-CityRail-France-Launcher-mac-universal.dmg` |
| Linux x64 | `MTR-CityRail-France-Launcher-linux-x86_64.AppImage` |
